...
$vars_vista['SUBTITULO']    = 'Lista de Contratistas';

$vars_vista['JS_FOOTER']    = [
	['JS_SCRIPT' => \App\Helper\Vista::get_url() . '/js/contratistas/contratistas.js'],
];
...
$vars_template['LINK'] = \App\Helper\Vista::get_url('index.php/contratistas/alta');

$content  = new \FMT\Template(TEMPLATE_PATH . '/contratistas/index.html', $vars_template, ['CLEAN' => false]);
