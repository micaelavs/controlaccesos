...
$vars_vista['SUBTITULO']    = 'Listado de Alerta de Relojes';

$vars_vista['JS_FOOTER']    = [
	['JS_SCRIPT' => \App\Helper\Vista::get_url() . '/js/alertarelojes/index.js'],
];
...
$vars_template['LINK'] = \App\Helper\Vista::get_url('index.php/AlertaRelojes/alta');

$content  = new \FMT\Template(TEMPLATE_PATH . '/alertarelojes/index.html', $vars_template, ['CLEAN' => false]);
