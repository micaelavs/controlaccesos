...
$vars_vista['SUBTITULO']    = 'Pertenencias';

$vars_vista['JS_FOOTER']    = [
	['JS_SCRIPT' => \App\Helper\Vista::get_url() . '/js/pertenencias/pertenencias.js'],
];
...
$vars_template['LINK'] = \App\Helper\Vista::get_url('index.php/pertenencias/alta');

$content  = new \FMT\Template(TEMPLATE_PATH . '/pertenencias/index.html', $vars_template, ['CLEAN' => false]);
