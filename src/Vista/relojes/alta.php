...
$vars_vista['SUBTITULO']		= 'Registrar Reloj';
...
$vars_template['IP']	= !empty($reloj->ip) ? ($reloj->ip) :'127.0.0.1';
$vars_template['PUERTO']	= !empty($reloj->puerto) ? ($reloj->puerto) :'3001';
...
$template = (new \FMT\Template(VISTAS_PATH.'/templates/relojes/alta.html', $vars_template,['CLEAN'=>false]));
$vars_vista['CONTENT'] = "$template";

$vars_vista['CSS_FILES'][]	= ['CSS_FILE' =>  \App\Helper\Vista::get_url().'/css/funkyradio.css'];
$vars_vista['JS_FOOTER'][]['JS_SCRIPT'] = \App\Helper\Vista::get_url().'/js/relojes/alta.js';
