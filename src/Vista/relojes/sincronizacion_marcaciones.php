...
$vars_vista['SUBTITULO']    = 'Lotes de Sincronización del Lote N° '.$id_lote;

$vars_vista['JS_FOOTER']    = [
    ['JS_SCRIPT' => \App\Helper\Vista::get_url().'/js/relojes/sincronizacion_marcaciones.js'],
];
...
$content  = new \FMT\Template(TEMPLATE_PATH.'/relojes/sincronizacion_marcaciones.html',$vars_template,['CLEAN'=>false]);
