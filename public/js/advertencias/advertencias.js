$(document).ready(function () {
    var tabla = $('#advertencias').DataTable({
        ...
        ajax: {
            url: $base_url + '/index.php/advertencias/ajax_advertencias',
        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    $html += ' <a href="' + $base_url + '/index.php/advertencias/modificacion/' + row.id + '" data-user="" data-toggle="tooltip" data-placement="top" title="Modificación de Advertencia" target="_self"><i class="fa fa-pencil"></i></a>&nbsp;';
                    $html += ' <a href="' +$base_url+'/index.php/advertencias/baja/'+row.id+'" class="borrar" data-user="" data-toggle="tooltip" data-placement="top" title="Eliminar Advertencia" target="_self"><i class="fa fa-trash"></i></a>';
                    $html += '</div>';
                    return $html;
                }
            },
